---
title: '[RFC-014] — Referral System'
description: 'Public users currently lack built-in growth mechanics to drive viral adoption. User acquisition relies primarily on paid marketing and organic discovery, which are costly and do not scale efficiently.'
...
sequenceDiagram
    ...
    REF->>DB: Update referral → COMPLETED
