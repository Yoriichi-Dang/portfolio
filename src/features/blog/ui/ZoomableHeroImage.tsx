  ...
  return (
    <>
      <motion.button
        ...
        whileTap={{ scale: 0.99 }}
        className="group mx-auto mb-6 flex aspect-video w-full cursor-zoom-in items-center justify-center overflow-hidden rounded-xl bg-gray-100 dark:bg-gray-800"
      ...
      >
        <motion.img
          ...
          height={height}
          loading="lazy"
          className="block aspect-video h-full w-full object-cover transition-transform duration-300 group-hover:scale-[1.02]"
        />
      </motion.button>
