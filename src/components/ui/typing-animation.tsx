...
const MOTION_ELEMENTS: Record<string, ElementType> = {
  span: motion.span,
  div: motion.div,
  p: motion.p,
  h1: motion.h1,
...
export function TypingAnimation({
  ...
  const Element = (typeof Component === 'string' && MOTION_ELEMENTS[Component]) || motion.span;
  ...
  return (
    <Element ref={elementRef} className={cn('leading-20 tracking-[-0.02em]', className)} {...props}>
      {displayedText}
      {shouldShowCursor && (
